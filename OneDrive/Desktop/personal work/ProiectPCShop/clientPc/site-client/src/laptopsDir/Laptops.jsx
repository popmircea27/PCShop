...
const Laptops = ({ maxPrice, laptopType, processorType, videoCardType }) => {
  ...
  useEffect(() => {
    getLaptops();
  }, [maxPrice, laptopType, processorType, videoCardType]); 
    ...
    <div className="laptop-list">
      {laptops.map((laptop) => (
        <Card 
          ...
          price={laptop.price} 
          id={laptop.id}
          procesor={laptop.processorType}
          placaVideo={laptop.videoCardType}
        />
      ))}
    </div>
  );
